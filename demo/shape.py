...
def main(frame):
    #frame= cv2.imread(cv2.cvtColor(img.copy(), 1))
...
if __name__ == "__main__":
     big_img = cv2.imread("Cercle.jpg", 1)
     main(big_img)
     big_img = cv2.imread("Carree.jpg", 1)
     main(big_img)
     big_img = cv2.imread("Triangle.jpg", 1)
     main(big_img)
     big_img = cv2.imread("Pentagon.jpg", 1)
     main(big_img)
     big_img = cv2.imread("ToutesFormes2.jpg", 1)
     main( big_img)
     big_img = cv2.imread("ToutesFormes.jpg", 1)
     main( big_img)
